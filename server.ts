...
import contentRoutes from './routes/website/contentRoutes';
import { getAdedata } from './controllers/contentController';
import donorRoutes from './routes/internal/donorroutes';
import donationRoutes from './routes/internal/donationroutes';
import volunteerRoutes from './routes/internal/volunteerRoutes';
import contactRoutes from './routes/internal/contactRoutes';
import adminRoutes from './routes/internal/adminRoutes';
import paymentRoutes from './routes/website/paymentRoutes';
import budgetRoutes from './routes/internal/budgetRoutes';
import programRoutes from './routes/internal/programRoutes';
import expenseRoutes from './routes/internal/expenseRoutes';
import reportRoutes from './routes/internal/reportRoutes';
